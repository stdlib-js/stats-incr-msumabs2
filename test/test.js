...
tape( 'main export is a function', function test( t ) {
	...
	t.strictEqual( typeof incrmsumabs2, 'function', 'main export is a function' );
	t.end();
});
...
tape( 'the function returns an accumulator function', function test( t ) {
	t.strictEqual( typeof incrmsumabs2( 3 ), 'function', 'returns expected value' );
	t.end();
});

tape( 'the accumulator function computes a moving sum of squared absolute values incrementally', function test( t ) {
	var expected;
	var actual;
	var data;
	var acc;
